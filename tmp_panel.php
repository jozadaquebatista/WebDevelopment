    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html"><?php echo $_SESSION['username']; ?> - Dashboard</a>
            </div>
            <!-- Top Menu Items -->
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-file"></i> Main
                            </li>
                            <li>
                                <i class="fa fa-dashboard"></i>  <a href="tmp_tasklist.php">Task List</a>
                            </li>
                        </ol>
                    </div>
