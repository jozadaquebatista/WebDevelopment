...
$(window).resize(function() {
    copyrightPos();
        ...
        $('#image-cb').change(function() {
            if ($(this).is(":checked")) {
                $.backstretch(["resources/assets/global/images/gallery/login.jpg"], {
                    fade: 600,
                    duration: 4000
                });
        ...
        $('#slide-cb').change(function() {
            if ($(this).is(":checked")) {
                $.backstretch(["resources/assets/global/images/gallery/login4.jpg", "../assets/global/images/gallery/login3.jpg", "../assets/global/images/gallery/login2.jpg", "../assets/global/images/gallery/login.jpg"], {
                    fade: 600,
                    duration: 4000
                });
